...
class Model(eqx.Module):
    ...
    def __init__(self, n_layers, state_dim, action_dim, width, hidden_size, *, key):
        keys = jax.random.split(key, 4)
        self.layers = eqx.nn.MLP(hidden_size, hidden_size, width, n_layers, key=keys[0])
